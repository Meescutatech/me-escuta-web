...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        // `data-[orientation=vertical]:`, nunca `data-[vertical]:` — a forma bare
        // compila para `[data-vertical]`, e o atributo emitido é
        // `data-orientation="vertical"`. Era esse o bug que deixava o grupo com
        // `spacing={0}` de cantos QUADRADOS: o arredondamento das pontas mora
        // no item, atrás de `group-data-horizontal/toggle-group:`, e essa regra
        // nunca casava. Falha silenciosa clássica (ver CLAUDE.md).
