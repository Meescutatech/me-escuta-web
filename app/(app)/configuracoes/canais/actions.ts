...
export async function definirNivelCanal(
  ...
  // exige que o `nivel` de lá seja o que acabou de ser pedido (linha `canal_nivel_alterado` em
  // CONFERENCIA).
  //
  ...
  // `canal_nivel_alterado`, `porta.aplicar_projetores` levanta PMEE1 quando não acha o tipo, e
